...
public interface Queries {
	...
	public interface ResturantQueries {
		...
		String GET_CATEGORY_BY_SHORTNAME="SELECT * FROM CATEGORY WHERE SHORTNAME = ?";
		...
		String INSERT_INTO_ORDER="INSERT INTO ORDERS(ORDER_ID,TABLE_ID,MENU_ID,QUANTITY,AMOUNT,STATUS,CREATED_ON,MODIFIED_ON,MERCHANT_ID) VALUES(?,?,?,?,?,?,?,?,?)";
